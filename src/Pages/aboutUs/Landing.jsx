  ...
  return (
    ...
    >
      <div className="text-center px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-[AeonikBold] mt-[-5] mb-4">
          About Us
        </h1>
        <p className="text-base sm:text-lg md:text-xl  font-[Aeoniklight] lg:text-2xl max-w-screen-md mb-8">
